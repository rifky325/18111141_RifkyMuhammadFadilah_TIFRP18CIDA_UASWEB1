        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <p>Greenpeace hadir karena bumi yang rapuh ini perlu suara. Butuh solusi. Butuh perubahan. Butuh aksi.
                    ...
                    lingkungan kami.</p>
                <p><a href="#" onclick="return alert('harus login')">Tentang GreenPeace Indonesia Selengkapnya</a></p>
            </div>
            <div class="col-md-3">
                ...
                <p><a href="#" onclick="return alert('harus login')">Sejarah GreenPeace Indonesia Selengkapnya</a></p>
            </div>
            <div class="col-md-3">
                ...
                <p>Selama bertahun-tahun, Greenpeace telah melakukan suatu perubahan positif untuk lingkungan dunia dan
                    ...
                    untuk lingkungan!</p>
                <p><a href="#" onclick="return alert('harus login')">Kemenangan Yang Kita Raih</a></p>
            </div>
            <div class="col-md-3">
                ...
                <p><a href="#" onclick="return alert('harus login')">Pendanaan GreenPeace Indonesia</a></p>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12 mb-3">
                <div class="card">
                    ...
                    <a href="#" onclick="return alert('harus login')">Lihat</a>
                    </div>
                </div>
            </div>
